...
| 知识域 | 首选一手资料 | 内容边界 |
| --- | --- | --- |
| C 语言 | ISO/IEC JTC1/SC22/WG14 的公开 C99/TC3 参考文本 [N1256](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n1256.pdf) 与 [WG14 文档索引](https://www.open-std.org/jtc1/sc22/wg14/www/docs/)；N1570 仅作为 C11 对比；工具链行为查 [GCC manuals](https://gcc.gnu.org/onlinedocs/) | 将“标准 C”“实现定义/未指定/未定义行为”“GCC 扩展”分开；代码题注明 `-std`、编译器版本和警告参数。 |
